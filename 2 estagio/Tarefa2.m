clear all
%Resolvi usar a função do degrau para ficar mais parecido com a convolução
%em Analise
% x é uma porta tamanho 5 começando em 1 h é uma porta tamanho 3 começando
% em 1 foi escolhido assim por o matlab não aceitar vetor com indexação 0
 sympref('HeavisideAtOrigin',0);
% sympref faz o degrau ser 0 na origem
for i =1:20
    x(i) = heaviside(i) - heaviside( i - 5);
